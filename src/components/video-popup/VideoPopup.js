          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="video-popup__image">
                <img src="/assets/img/product/fashion/social.png" alt="Rezingo" class="img-fluid"/>
                </div>
                </div>
                <div class="col-lg-6">
                  <div class="video-popup__content">
                    <h2 class="title mb-30">Social Wellness</h2>
                    <p class="text mb-30">Social wellness encompasses a variety of healthy behaviors including adequate exercise, proper nutrition and abstaining from harmful habits such as drug use and alcohol abuse. It means learning about and identifying symptoms of disease, getting regular medical checkups, and protecting yourself from injuries and harm.</p>
                    <div className="link mb-30">
                <Link to={process.env.PUBLIC_URL + "/about"}>
                  More About Us
                </Link>
              </div>
                      <ModalVideo channel="youtube" isOpen={modalStatus} videoId="f3dBPulbLSk" onClose={() => isOpen(false)} />
              <button onClick={() => isOpen(true)}>
                <i className="fa fa-play-circle"></i>
              </button>
                        </div>
