...
const BlogSection = ({
  ...
  <div className="justify-content-center d-flex my-5">
     <img src={"/assets/img/blog/Secondary_Kate.jpg"} alt="Rezingo" style={{width:"100%"}}/>
  </div>
...
<img src="https://REZINGO.life/assets/images/img-1.png" alt="Rezingo" className="img-style2"/>
</div>
